...
function sportplatzNav() {

  window.location.replace('Games/sportplatz/sportplatz.html');
...
function getMap() {
  ...
  //Sportplatz
  var locationsportplatz = new Microsoft.Maps.Location(52.5196390, 13.3731570);
  var sportplatzPinOptions = {
    width: null,
    height: null,
    htmlContent: "<div class='pushpin'>Sportplatz</div>"
  };
  ...
  //Sportplatz
  var pinsportplatz = new Microsoft.Maps.Pushpin(locationsportplatz, sportplatzPinOptions);
  ...
  //AllDrink
  pinsportplatzInfobox = new Microsoft.Maps.Infobox(pinsportplatz.getLocation(), {
    title: 'Sportplatz',
    description: 'Infobox description',
    actions: [{
      label: 'GoTo Game',
      eventHandler: sportplatzNav
    }],
    visible: false,
  });
  ...
  //AF
  Microsoft.Maps.Events.addHandler(pinsportplatz, 'click', displaysportplatzInfobox);
  ...
  //AF
  Microsoft.Maps.Events.addHandler(map, 'viewchange', hidesportplatzInfobox);
  ...
  //Sportplatz
  map.entities.push(pinsportplatz);
  map.entities.push(pinsportplatzInfobox);
}
//Sammo
function displayBalkonInfobox(e) {
  pinBalkonInfobox.setOptions({
    visible: true
  });
}
...
//sportplatz
function displaysportplatzInfobox(e) {
  pinsportplatzInfobox.setOptions({
    visible: true
  });
}

function hidesportplatzInfobox(e) {
  pinsportplatzInfobox.setOptions({
    visible: false
  });
}
